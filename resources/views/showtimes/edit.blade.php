@extends('layout.app')
@section('title', 'Showtime edition')
@section('content')
    <div class="container-fluid">
        <h2>Edit showtime's database</h2>
        <form method="post" action="{{ route('showtime.update', $showtime->id)}}"  enctype="multipart/form-data">
            {{csrf_field()}}
            {{ method_field('PUT') }}
            <div class="form-group">
                <label for="name">Code</label>
                <input type="text" name="code" id="code" value="{{ $showtime->code }}" required/>
                @if ($errors->has('code'))
            ...
            <div class="form-group">
                ...
                <input type="text" name="theatre_name" id="theatre_name" value="{{$showtime->theatre_name}}" required/>
            ...
            <div class="form-group">
                ...
                <input type="number" name="movie_id" id="movie_id" value="" required/>
